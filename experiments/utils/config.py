...
class Config:
    def __init__(self, cfg_id, test=False):
        self.id = cfg_id
        cfg_name = 'experiments/cfg/%s.yml' % cfg_id
        ...
        self.dataset_path = cfg.get('dataset_path', '/home/yzhang/Videos/AMASS-Canonicalized/data/')
        ...
        self.body_repr = cfg.get('body_repr','marker_41')

        # vae
        self.nz = cfg['nz']
        self.beta = cfg['beta']
        self.lambda_v = cfg.get('lambda_v', 0)
        self.lambda_tf = cfg.get('lambda_tf', 0)
        self.lambda_reg = cfg.get('lambda_reg', 0)
        ...
        self.robustkl = cfg.get('robustkl', False)
